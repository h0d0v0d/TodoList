    ...
    case "CHANGE-TASK-STATUS": {
      return {
        ...
        [action.todolistId]: state[action.todolistId].map((t) =>
          t.id === action.taskId ? action.updatedTask : t
        ),
      };
    }
...
export type TasksActionsType = ReturnType<
  PropertiesType<typeof tasksReducerActions>
>;
...
export const tasksReducerActions = {
  ...
  addTaskAC: (todolistId: string, newTask: TaskType) =>
    ({ type: "ADD-TASK", newTask, todolistId } as const),
  changeTaskStatusAC: (
    todolistId: string,
    taskId: string,
    updatedTask: TaskType
  ) =>
    ({ type: "CHANGE-TASK-STATUS", todolistId, taskId, updatedTask } as const),
  changeTaskTitleAC: (todolistId: string, taskId: string, task: TaskType) =>
    ({ type: "CHANGE-TASK-TITLE", todolistId, taskId, task } as const),
